...
fx <- expression(x^2)
#find the derivatve with respect to x
...
#exapmle 2
dt-dy <- D(expr = expression((2*y^3 + 1)^4 - 8*y^3), name = "y")
dt_dy

#find the slope of T(y) at a range of values
y <- seq(from = _0.4, to = 2.0, by = 0.1)
...
ggplot(data = penguins, aes(x = body_mass_g, y = flipper_length_mm)) + 
  ...
  labs( x = "Body mass (g)",
        ...
        subtitle = "Palmer archipelago, Antartice (2007 - 2009)",
